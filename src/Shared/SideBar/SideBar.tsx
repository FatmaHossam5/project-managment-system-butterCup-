    ...
    <>
      ...
      <div style={{ display: "flex", height: "100%", minHeight: "400px" }}>
          ...
          <Menu>
            ...
            {role === "Manager" ? (
              <MenuItem
                style={{ fontSize: "12px" }}
                icon={
                  <i className="fa fa-users fa-2x ico" aria-hidden="true"></i>
                }
            ...
            <MenuItem
              style={{ fontSize: "12px" }}
              icon={
                <i className="fa-solid fa-arrow-right-from-bracket ico fa-2x"></i>
              }
              onClick={logOut}
            >
              {" "}
        ...
        <main style={{ padding: 10 }}>
          <div>
            <div
              className=" position-relative arrow "
              onClick={() => setIsCollapsed(!isCollapsed)}
            >
              {isCollapsed ? (
                <i className="fa-solid fa-chevron-left text-white position-absolute"></i>
              ) : (
                <i className="fa-solid fa-chevron-right text-white coll position-absolute"></i>
              )}
            </div>
          </div>
        </main>
